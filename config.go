...
type memoryDB struct {
  ...
  books  map[int64]*mydb.Book // maps from Book ID to Book.
}

var (
	DB          mydb.BookDatabase
...
// 	return &memoryDB{
// 		books:  make(map[int64]*mydb.Book),
// 		nextID: 1,
// 	}
// }
...
func init() {
	...
	// DB, err = configureDatastoreDB("bdalton-174620")
	// [END datastore]
	...
	// bucket name.
	//
	// StorageBucketName = "bdalton-174620"
	...
	//
	// PubsubClient, err = configurePubsub("bdalton-174620")
	// [END pubsub]
...
func configureCloudSQL(config cloudSQLConfig) (mydb.BookDatabase, error) {
	if os.Getenv("GAE_INSTANCE") != "" {
		// Running in production.
		// return newMySQLDB(MySQLConfig{
		return mydb.NewMySQLDB(mydb.MySQLConfig{
    ...
    Username: "root",
		Password: "sock2904guitar",
		Host:     "norway-174805:us-central1:norway-sql",
		Port:     3307,
	})
}
